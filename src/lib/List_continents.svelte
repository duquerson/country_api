...
<div class=" mt-4 lg:mt-0 flex flex-row flex-nowrap lg:w-[200px] w-[440px] h-[60px] justify-between  bg-white dark:bg-menu-color-dark dark:text-white rounded-lg shadow-lg">
